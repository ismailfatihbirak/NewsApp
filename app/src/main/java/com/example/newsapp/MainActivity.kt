...
fun PageTransations() {
    ...
    NavHost(navController, startDestination = "homepage") {
        ...
        composable("newsdetail/{url}") { backStackEntry ->
            NewsDetail(navController, backStackEntry.arguments?.getString("url")!!)
        }
    }
}
                ...
                LazyRow{
                    items(
                        ...
                        itemContent = {
                            ...
                            Card(modifier = Modifier.size(345.dp, 215.dp).padding(start = 10.dp)) {
                            ...
                            Card(
                                ...
                                ElevatedButton(
                                    ...
                                    colors = ButtonDefaults.buttonColors(
                                        containerColor = if (selectedButtonIndex.value == it) colorResource(id = R.color.primary) else Color.White
                                    )
                                ) {
                                    Text(
                                        text = ctgry,
                                        fontSize = 12.sp,
                                        color = if (selectedButtonIndex.value == it) Color.White else Color.Black
                                    )
                                }
                            }
                        }
                ...
                LazyColumn{
                    items(
                        ...
                        itemContent = {
                            ...
                            Card(
                                modifier = Modifier.height(150.dp).padding(all = 10.dp)
                            ) {
                                Row(modifier = Modifier.weight(1f).clickable {
                                    navController.navigate("newsdetail/${URLEncoder.encode(new.url, StandardCharsets.UTF_8.toString())}")
                                }) {
                                    Box(modifier = Modifier.weight(1f)){
                                        ...
                                        Column (modifier = Modifier.padding(all = 8.dp)) {
                                            ...
                                            Row {
                                                Text(
                                                    text = new.author?: "remove title",
                                                    fontSize = 12.sp,
                                                    color = Color.White
                                                )
                                                Spacer(modifier = Modifier.weight(1f))
                                                Text(
                                                    text = new.publishedAt.dropLast(10)?: "remove title",
                                                    fontSize = 12.sp,
                                                    color = Color.White
                                                )
                                            }
